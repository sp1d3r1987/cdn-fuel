...
Config.BlowUpChance = 12 -- Percentage for Chance of Engine Explosion (Default: 5% or 5)
Config.CostMultiplier = 2.0 -- Amount to multiply 1 by. This indicates fuel price. (Default: $3.0/l or 3.0)
Config.GlobalTax = 8.0 -- The tax, in %, that people will be charged at the pump. (Default: 15% or 15.0)
...
Config.EmergencyServicesDiscount = {
    ...
    ['discount'] = 100, -- % Discount off of price (before tax).
...
Config.SyphonPoliceCallChance = 80 -- Math.Random(1, 100) Default: 25%
...
Config.JerryCanPrice = 300 -- The price of a jerry can, not including tax.
